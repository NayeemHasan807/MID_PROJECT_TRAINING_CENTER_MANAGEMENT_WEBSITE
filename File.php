				...
				<td>
					<table width="100%">
						<tr>
							...
							<td colspan="2" width="70%"><b>File Name</b></td>
						</tr>
						<tr><td colspan="3"><hr/></td></tr>
						<tr>
							<td width="30%">1.</td>
							<td width="50%">Lecture1.ppt</td>
							<td width="20%">
								<button type="button">
									Delete
								</button>
						...
						<tr>
							<td colspan="3">
								<form>
									Add File: <input type="file" name="file"><input type="submit" name="Add">
								</form>
							</td>
						</tr>
						<tr><td colspan="3"><hr/></td></tr>
